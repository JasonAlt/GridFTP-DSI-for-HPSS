...
static const char * DSI_NAME = "hpss";
...
activate(void)
{
    ...
    globus_module_descriptor_t * Module = GlobusExtensionMyModule(globus_gridftp_server_hpss);
    globus_extension_registry_add(
        GLOBUS_GFS_DSI_REGISTRY, (char *)DSI_NAME, Module, dsi_interface);
